...
public class PBDCloth : ICloth
{
    ...
    public PBDCloth(int N, float3 startPos, float nodeStep, float density)
    {
    ...
    public void updateStep(float3 ballPos) => UpdateStep(ballPos);


    public ClothData[] getColthDrawData() => GetClothDrawData();
